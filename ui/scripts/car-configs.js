...
function setupEventListeners() {
	...
	if (confirmSaveAsBtn) confirmSaveAsBtn.addEventListener('click', confirmSaveAs);
	const cancelSaveAsBtn = document.getElementById('cancelSaveAs');
	if (cancelSaveAsBtn) cancelSaveAsBtn.addEventListener('click', hideSaveAsModal);
